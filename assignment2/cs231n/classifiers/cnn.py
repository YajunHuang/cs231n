...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        W2 = np.random.normal(0, weight_scale, (num_filters * (1 + (input_dim[1] - 2) / 2)**2, hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        N, C, HH, WW = X.shape
        crp_out, crp_cache = conv_relu_pool_forward(X, W1, b1, conv_param=conv_param, pool_param=pool_param)
        # print crp_out.shape, W2.shape
        ...
        dx2, dW3, db3 = affine_backward(dx3, scores_cache)
        dx1, dW2, db2 = affine_relu_backward(dx2, ar_cache)
        _, dW1, db1 = conv_relu_pool_backward(dx1, crp_cache)
